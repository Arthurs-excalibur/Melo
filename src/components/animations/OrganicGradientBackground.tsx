...
export const OrganicGradientBackground = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div style={{ position: 'absolute', width: '100%', height: '100%', overflow: 'hidden', inset: 0 }}>
      <div 
        ref={mountRef} 
        style={{ 
          position: 'absolute', 
          ...
          height: '100%',
          zIndex: 1,
          opacity: 0.6 // Toning it down slightly to act as a background
        }} 
      />
      <div 
        style={{ 
