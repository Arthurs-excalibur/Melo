...
// You'll need to create or import the CSS for these classes
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'main_wrapper flex items-center justify-center min-h-screen bg-background', // Added some default tailwind classes for the container
          className
        )}
        {...props}
      >
