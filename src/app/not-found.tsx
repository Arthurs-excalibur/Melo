...
export default function NotFound() {
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center py-16 px-4 md:py-24 md:px-20 relative overflow-hidden">
      {/* Smoke Background with Red Color */}
      <SmokeBackground smokeColor="#ff0000" className="opacity-60" />
